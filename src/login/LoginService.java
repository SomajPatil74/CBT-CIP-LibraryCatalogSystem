...
public class LoginService {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    studentService.addUser(conn);
                    break;
                case 6:
                    studentService.getAllUsers(conn);
                    break;
                case 7:
    ...
    public void displayUserMenu(Connection conn) throws SQLException {
        int choice;
        BookService bookService = new BookService();
        ...
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Thank You for using Library Catalog System.");
                    System.exit(0);
                    break;
                default:
                    System.out.println("Please select valid option.");
